...
<body class="theme-red">
    ...
    <!-- Morris Plugin Js -->
    <script src="BSB/plugins/raphael/raphael.min.js"></script>
    <script src="BSB/plugins/morrisjs/morris.js"></script>

    <!-- ChartJs -->
    <script src="BSB/plugins/chartjs/Chart.bundle.js"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="BSB/plugins/flot-charts/jquery.flot.js"></script>
    <script src="BSB/plugins/flot-charts/jquery.flot.resize.js"></script>
    <script src="BSB/plugins/flot-charts/jquery.flot.pie.js"></script>
    <script src="BSB/plugins/flot-charts/jquery.flot.categories.js"></script>
    <script src="BSB/plugins/flot-charts/jquery.flot.time.js"></script>
    ...
    <script src="BSB/js/pages/index.js"></script>

    <!-- Demo Js -->
    <script src="BSB/js/demo.js"></script>
</body>
